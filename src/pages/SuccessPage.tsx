...
const SuccessPage = () => {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8 gap-4">
        ...
        {/* One-time activation payment, inline below the success card */}
