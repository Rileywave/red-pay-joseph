...
export const Route = createFileRoute("/admin/_panel/activations")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Confirm or reject ₦8,600 account activation payments." },
      { property: "og:title", content: "RedPay Admin — Activations" },
      { property: "og:description", content: "Confirm or reject ₦8,600 account activation payments." },
